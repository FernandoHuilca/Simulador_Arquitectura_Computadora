...
public class CPU {
    ...
    public void imprimirEnConsolaCPU() {
        ...
        System.out.println("___________ Entradas y salida de la ALU ______________");
        // Imprimir entradas de la alu
        System.out.println("   Entrada A " + alu.getEntradaA() + "\n   Entrada B " + alu.getEntradaB() + "\n   Salida " + alu.getSalida());
    }
